...
#---------LIVE Settings----------#
gdb.path <- "M:\\MONITORING\\StreamsLakes\\Data\\Database\\AGOLBackups\\MOJN_STLK_AnnualLakeVisit_20210224.gdb"
photo.dest <- "M:\\MONITORING\\StreamsLakes\\Data\\ImageData\\Lakes"
originals.dest <- "M:\\MONITORING\\_FieldPhotoOriginals_DoNotModify"
db.params.path <- "LIVE-stlk-database-conn.csv"
#---------------------------#
